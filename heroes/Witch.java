...
public class Witch extends Heroes{
    ...
    public int fleSpeed;
    public Witch(String name, int hp, int attack, int armor, int power, int weight, boolean flag, int fleSpeed) {
        super(name, hp, attack, armor, power, weight, flag);
        this.fleSpeed = fleSpeed;
    }

    public void startGame() {
        flag = true;
        System.out.println(name+" на поле боя!");
    }
    ...
    public void info(){
        System.out.println( "Информация о персонаже "+name+": HP:"+ hp+" attack: "+ attack+" armor: "+ armor+" power: "+ power+" flag: "+ flag+ " weight: "+ weight);
    }
